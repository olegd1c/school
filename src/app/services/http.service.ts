...
export class HttpService extends HttpClient {
    ...
    */
    private optionsR = { headers: new HttpHeaders({ 'Content-Type': 'application/json', 'charset': 'UTF-8' }) };
    ...
    _edit(entity: any): Observable<any> {
        return this.put(`${this.url}/${entity._id}`, JSON.stringify(entity), this.optionsR);
    }
